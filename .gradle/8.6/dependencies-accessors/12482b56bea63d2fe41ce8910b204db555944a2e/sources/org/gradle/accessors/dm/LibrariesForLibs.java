...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxCredentialsLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>v150</b> with <b>androidx.credentials:credentials</b> coordinates and
         * with version reference <b>credentialsVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getV150() {
            return create("androidx.credentials.v150");
        }
    ...
    public static class CredentialsPlayServicesLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>credentials.play.services.auth</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        private final CredentialsVersionAccessors vaccForCredentialsVersionAccessors = new CredentialsVersionAccessors(providers, config);
        ...
        /**
         * Group of versions at <b>versions.credentials</b>
         */
        public CredentialsVersionAccessors getCredentials() {
            return vaccForCredentialsVersionAccessors;
        }
    ...
    public static class CredentialsVersionAccessors extends VersionFactory  implements VersionNotationSupplier {

        private final CredentialsPlayVersionAccessors vaccForCredentialsPlayVersionAccessors = new CredentialsPlayVersionAccessors(providers, config);
        public CredentialsVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
         ...
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> asProvider() { return getVersion("credentials"); }

        /**
         * Group of versions at <b>versions.credentials.play</b>
         */
        public CredentialsPlayVersionAccessors getPlay() {
            return vaccForCredentialsPlayVersionAccessors;
        }

    }

    public static class CredentialsPlayVersionAccessors extends VersionFactory  {

        private final CredentialsPlayServicesVersionAccessors vaccForCredentialsPlayServicesVersionAccessors = new CredentialsPlayServicesVersionAccessors(providers, config);
        public CredentialsPlayVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Group of versions at <b>versions.credentials.play.services</b>
         */
        public CredentialsPlayServicesVersionAccessors getServices() {
            return vaccForCredentialsPlayServicesVersionAccessors;
        }

    }

    public static class CredentialsPlayServicesVersionAccessors extends VersionFactory  {

        public CredentialsPlayServicesVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>credentials.play.services.auth</b> with value <b>1.3.0-alpha03</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getAuth() { return getVersion("credentials.play.services.auth"); }
    ...
    public static class FirebaseVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>firebase.bom</b> with value <b>33.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
